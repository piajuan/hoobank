...
const FeatureCard = ( {icon, title, content, index} ) => (
  <div className={`flex flex-row p-6 rounded-[20px] gap-5 feature-card transition-all duration-200 ease-in-out`}>
    <div className={`w-[64px] h-[64px] rounded-full ${styles.flexCenter} bg-dimBlue`}>
      <img src={icon} alt="icon" className='w-[50%] aspect-square object-contain'/>
    </div>
